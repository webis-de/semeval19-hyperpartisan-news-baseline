...
public class InfexBATokenizer extends JCasAnnotator_ImplBase{
	...
	throws ResourceInitializationException {
		...
		urlPrefixLexicon = this.loadLexicon(urlPath, false, true);
		abbreviationLexicon = this.loadLexicon(abbreviationPath, false, true);
	}
	 ...
	 * @return The lexicon
	 */
	private Set<String> loadLexicon(String filePath, boolean toUpperCase, 
			boolean toLowerCase){
		Set<String> lexicon = new HashSet<String>();
    try (BufferedReader in = new BufferedReader(new InputStreamReader(
        ClassLoader.getSystemResourceAsStream(filePath), "UTF8"));) {
		    String str;
